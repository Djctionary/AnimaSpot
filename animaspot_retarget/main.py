...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--smooth_window", type=int, default=7, help="Savitzky-Golay smoothing window.")
...
def main() -> None:
    ...
    cfg = RetargetConfig(smooth_window=args.smooth_window)
    ...
    print(f"Wrote debug NPZ: {out_npz}")
